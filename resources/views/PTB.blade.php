...
<head>
    ...
    <link rel="icon" href="{{asset('theme/production/images/Pentuba.ico')}}" type="image/ico" />

    <title>@yield('Judul')- PENTUBA</title>
            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="{{asset('/PENTUBA')}}" class="site_title"><img
                                src="{{asset('theme/production/images/Pentuba.ico')}}" width="48px"
                                height="50px">&nbsp;&nbsp;<span>@yield('Logo')</span></a>
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{asset('/PENTUBA')}}"><i class="fa fa-home"></i> Home </a>
                                </li>
                                <li><a><i class="fa fa-table"></i> Data Master <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{asset('/User')}}">Data User</a></li>
                                        <li><a href="{{asset('/PenyediaTB')}}">Data PENTUBA</a></li>
                                        <li><a href="{{asset('/Tukang')}}">Data Tukang</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <div class="sidebar-footer hidden-small">
                        <a data-toggle="tooltip" data-placement="top" title="Logout"
                            href="{{asset('theme/production/login.html')}}" style="width: 100%">
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="Profil2.jpg" alt="">Nurul Aulia
                                </a>
